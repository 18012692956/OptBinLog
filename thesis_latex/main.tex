...
\newenvironment{Shaded}{\begin{snugshade}\noindent}{\end{snugshade}}
...
\urlstyle{same}
\renewcommand{\UrlFont}{\tnr\zihao{-4}}
...
\AtBeginEnvironment{thebibliography}{%
  \songti\tnr\zihao{-4}\setstretch{1.5}%
...
\newcommand{\whuheadertext}{%
  武\hspace{0.55em}汉\hspace{0.55em}大\hspace{0.55em}学\hspace{0.55em}本\hspace{0.55em}科\hspace{0.55em}毕\hspace{0.55em}业\hspace{0.55em}论\hspace{0.55em}文\hspace{0.55em}（\hspace{0.55em}设\hspace{0.55em}计\hspace{0.55em}）%
}
\fancyhead[C]{\songti\zihao{5} \whuheadertext}
\fancyfoot[C]{\thepage}
...
\newcommand{\thesistitle}{嵌入式系统中高效二进制日志管理机制的研究与设计}
...
\begin{titlepage}
  ...
  \vspace{0.8cm}
  {\songti\zihao{2} 本科毕业论文（设计）\par}
  \vspace{2.5cm}
  {\kai\zihao{1} \thesistitle\par}
  \vspace{2.5cm}
  {\songti\zihao{4}
  \renewcommand{\arraystretch}{1.9}
  \begin{tabular}{@{}>{\centering\arraybackslash}p{4.6em}>{\centering\arraybackslash}p{1em}>{\centering\arraybackslash}p{12em}@{}}
    姓\hfill 名 & ： & \studentname \\
    学\hfill 号 & ： & \studentid \\
    专\hfill 业 & ： & \majorname \\
    学\hfill 院 & ： & \schoolname \\
    指导教师 & ： & \advisorname \\
  \end{tabular}\par
  }
  \vfill
...
\setcounter{page}{1}
\makeatletter
\let\thesis@orig@section\section
\renewcommand{\section}{%
  \@ifstar{\thesis@section@star}{\thesis@section@nostar}%
}
\newcommand{\thesis@section@star}[1]{%
  \thesis@orig@section*{#1}%
}
\newcommand{\thesis@section@nostar}[1]{%
